...
if __name__ == "__main__":
    ...
    input_folder_path = '/home/esener/thesis/Thesis/data/output/stream_tweetids_2022-08_splitted'
    output_folder_path = '../data/output/missing_tweets/2_stream_tweetids_2022-08_splitted'
